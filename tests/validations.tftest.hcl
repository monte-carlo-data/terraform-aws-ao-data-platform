...
//
// Requires Terraform >= 1.7 for mock_provider / override_module / override_data.
// The module itself stays at required_version >= 1.3; these .tftest.hcl files
// are dev-only and no-op on older Terraform versions.
